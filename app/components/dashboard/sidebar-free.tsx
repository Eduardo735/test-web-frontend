...
export function SidebarFree({
  ...
  const menuItems = [
    ...
    // { id: "setups", label: "Live Setups", icon: Radio },
    // { id: "community", label: "Community Pro", icon: ContactRound },
    // { id: "support", label: "Support", icon: MessageCircleWarning },
  ];

  return (
    <div
      className={cn(
        "flex flex-col bg-background transition-all duration-300 mx-2",
        collapsed ? "w-16" : "w-64"
      )}
    >
